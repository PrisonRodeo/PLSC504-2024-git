...
#
# This is R code to grab & create data from the 
# World Bank's _World Development Indicators_. 
# These are the "running example" data that we 
# use in the panel data part of the course.
#
...
write.csv(wdi,"WDI-24.csv",row.names=FALSE)
...
write.csv(wdi2,"WDI2-24.csv",row.names=FALSE)
