...
# Introduction                                   ####
#
# PLSC 503 -- Spring 2024: Code for Week Ten:
# MLE + Testing + Binary Response Models...
#
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Packages:
...
COVID<-read_csv("https://raw.githubusercontent.com/PrisonRodeo/PLSC503-2024-git/master/Data/COVID-PA.csv")
